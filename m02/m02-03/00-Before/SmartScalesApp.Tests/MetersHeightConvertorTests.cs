...
public class MetersHeightConvertorTests
{
    ...
    {
        var convertor = new MetersHeightConvertor();

        var calculatedheightInMeters = convertor.ConvertFromCM(heightInCms);
    ...
    public void ConvertToCM_InputIsInMeters_ReturnInCMs(decimal heightInMeters, decimal expectedheightInCms)
    {
        ...
        var calculatedheightInCMs = convertor.ConvertToCM(heightInMeters);
