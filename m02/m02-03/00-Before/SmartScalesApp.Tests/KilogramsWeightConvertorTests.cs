...
public class KilogramsWeightConvertorTests
{
    ...
    {
        var convertor = new KilogramsWeightConvertor();

        var calculatedWeightInKilograms = convertor.ConvertFromPounds(WeightInPounds);
    ...
    public void ConvertToPounds_InputIsInKilograms_ReturnInPounds(decimal WeightInKilograms, decimal expectedWeightInPounds)
    {
        ...
        var calculatedWeightInPounds = convertor.ConvertToPounds(WeightInKilograms);
