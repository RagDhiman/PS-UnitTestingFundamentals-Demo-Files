...
public class InchesHeightConvertorTests
{
    ...
    {
        var convertor = new InchesHeightConvertor();

        var calculatedheightInInches = convertor.ConvertFromCM(heightInCms);
    ...
    public void ConvertToCM_InputIsInInches_ReturnInCMs(decimal heightInInches, decimal expectedheightInCms)
    {
        ...
        var calculatedheightInCMs = convertor.ConvertToCM(heightInInches);
